...
---
<a name="Spring Boot Annotations"></a>
...
---
<a name="Jakarta Bean Validation"></a>
...
[Обратно к Lombok](#Lombok) / [Обратно к Spring Boot Annotations](#Spring Boot Annotations) / [Обратно к Jakarta](#Jakarta) / [Обратно к Jakarta Bean Validation](#Jakarta Bean Validation)
